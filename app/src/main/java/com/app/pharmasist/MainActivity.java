...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<String> testDeviceIds = Arrays.asList("3554A79D3DF1E9863AEC39F4DBE22E19");
                    ...
                    try {
                        ...
                        if (jArray.length() > 0) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                */
                                searchableProduct.productId = jsonObjectProduct.getInt("product_id");
                                searchableProduct.productName = jsonObjectProduct.getString("product_name");
                                searchableProduct.productForm = jsonObjectProduct.getString("product_form");
                                searchableProduct.productDose = jsonObjectProduct.getString("product_cntr");
                                searchableProduct.productQuantity = jsonObjectProduct.getInt("product_quantity");
                                searchableProduct.productPrice = jsonObjectProduct.getDouble("product_price");
                                searchableProduct.productExpiration = java.sql.Date.valueOf(jsonObjectProduct.getString("product_expiration"));
                                ...
                                searchableProduct.moorningStart = Time.valueOf(jsonObjectUser.getString("moorning_start"));
                                searchableProduct.moorningEnd = Time.valueOf(jsonObjectUser.getString("moorning_end"));
                                searchableProduct.eveningStart = Time.valueOf(jsonObjectUser.getString("evening_start"));
                                searchableProduct.eveningEnd = Time.valueOf(jsonObjectUser.getString("evening_end"));
