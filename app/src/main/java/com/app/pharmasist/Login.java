                ...
                if (!response.equals(null)) {
                    ...
                    try {
                        ...
                        if(jArray.length() > 0) {
                            ...
                            User.setMoorningStart(Time.valueOf(jObject.getString("moorning_start")));
                            User.setMoorningEnd(Time.valueOf(jObject.getString("moorning_end")));
                            User.setEveningStart(Time.valueOf(jObject.getString("evening_start")));
                            User.setEveningEnd(Time.valueOf(jObject.getString("evening_end")));
